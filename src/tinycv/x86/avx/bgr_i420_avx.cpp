...
struct YUV420p2RGB_u8_avx128 {
    ...
    void process(__m128i v_y, __m128i v_u, __m128i v_v, __m128i &v_u1, __m128i &v_v1, __m128i &v_r, __m128i &v_g, __m128i &v_b) const
    {
    ...
    void operator()(int32_t height, int32_t width, int32_t yStride, const uint8_t *y1, int32_t uStride, const uint8_t *u1, int32_t vStride, const uint8_t *v1, int32_t outWidthStride, uint8_t *dst) const
    {
        ...
        uint8_t *outData)
{
    ...
    if (dcn == 3) {
        ...
        s.operator()(height, width, yStride, inDataY, uStride, inDataU, vStride, inDataV, outWidthStride, outData);
    } else if (dcn == 4) {

...
void ResizeLinearTest(int32_t inHeight, int32_t inWidth, int32_t outHeight, int32_t outWidth, T diff)
{
    ...
    tinycv::debug::randomFill<T>(src.get(), inWidth * inHeight * nc, 0, 255);
    ...
    tinycv::ResizeLinear<T, nc>(inHeight, inWidth, inWidth * nc, src.get(), outHeight, outWidth, outWidth * nc, dst.get());
...
void ResizeNearestTest(int32_t inHeight, int32_t inWidth, int32_t outHeight, int32_t outWidth, T diff)
{
    ...
    tinycv::ResizeNearestPoint<T, nc>(inHeight, inWidth, inWidth * nc, src.get(), outHeight, outWidth, outWidth * nc, dst.get());

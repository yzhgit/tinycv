...
#ifndef __ST_TINYCV_X86_INTERNAL_FMA_H_
#define __ST_TINYCV_X86_INTERNAL_FMA_H_
...
template <typename T, int32_t nc, tinycv::BorderType borderMode>
...
#endif //! __ST_TINYCV_X86_INTERNAL_FMA_H_

...
void BM_NV2BGR_tinycv_aarch64(benchmark::State &state)
{
...
BENCHMARK_TEMPLATE(BM_NV2BGR_tinycv_aarch64, uint8_t, NV122RGB_MODE)->Args({ 320, 240 })->Args({ 640, 480 })->Args({ 1280, 720 })->Args({ 1920, 1080 })->Args({ 3840, 2160 });
BENCHMARK_TEMPLATE(BM_NV2BGR_tinycv_aarch64, uint8_t, NV122BGR_MODE)->Args({ 320, 240 })->Args({ 640, 480 })->Args({ 1280, 720 })->Args({ 1920, 1080 })->Args({ 3840, 2160 });
BENCHMARK_TEMPLATE(BM_NV2BGR_tinycv_aarch64, uint8_t, NV212RGB_MODE)->Args({ 320, 240 })->Args({ 640, 480 })->Args({ 1280, 720 })->Args({ 1920, 1080 })->Args({ 3840, 2160 });
BENCHMARK_TEMPLATE(BM_NV2BGR_tinycv_aarch64, uint8_t, NV212BGR_MODE)->Args({ 320, 240 })->Args({ 640, 480 })->Args({ 1280, 720 })->Args({ 1920, 1080 })->Args({ 3840, 2160 });

    ...
    void apply()
    {
        if (mode == tinycv::INTERPOLATION_LINEAR) {
            ...
            tinycv::ResizeNearestPoint<T, channels>(this->inHeight,
                                                    ...
                                                    this->outWidth * channels,
                                                    this->dev_oImage);
        } else if (mode == tinycv::INTERPOLATION_AREA) {
            tinycv::ResizeArea<T, channels>(this->inHeight,
                                            this->inWidth,
                                            this->inWidth * channels,
                                            this->dev_iImage,
                                            this->outHeight,
...
template<typename T, int channels, int mode>
static void BM_Resize_tinycv_arm(benchmark::State &state)
{
...
using tinycv::INTERPOLATION_AREA;
using tinycv::INTERPOLATION_LINEAR;
using tinycv::INTERPOLATION_NEAREST_POINT;

BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c1, INTERPOLATION_LINEAR)->Args({ 1080, 1920, 180, 320 })->Args({ 1080, 1920, 270, 480 });
BENCHMARK_TEMPLATE(BM_Resize_opencv_arm, uint8_t, c1, INTERPOLATION_LINEAR)->Args({ 1080, 1920, 180, 320 })->Args({ 1080, 1920, 270, 480 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c3, INTERPOLATION_LINEAR)->Args({ 1080, 1920, 180, 320 })->Args({ 1080, 1920, 270, 480 });
BENCHMARK_TEMPLATE(BM_Resize_opencv_arm, uint8_t, c3, INTERPOLATION_LINEAR)->Args({ 1080, 1920, 180, 320 })->Args({ 1080, 1920, 270, 480 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c4, INTERPOLATION_LINEAR)->Args({ 1080, 1920, 180, 320 })->Args({ 1080, 1920, 270, 480 });
BENCHMARK_TEMPLATE(BM_Resize_opencv_arm, uint8_t, c4, INTERPOLATION_LINEAR)->Args({ 1080, 1920, 180, 320 })->Args({ 1080, 1920, 270, 480 });

// tinycv
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, float, c1, INTERPOLATION_LINEAR)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, float, c3, INTERPOLATION_LINEAR)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, float, c4, INTERPOLATION_LINEAR)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
// opencv
...
// tinycv
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, float, c1, INTERPOLATION_NEAREST_POINT)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, float, c3, INTERPOLATION_NEAREST_POINT)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, float, c4, INTERPOLATION_NEAREST_POINT)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
// opencv
...
// tinycv
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, float, c1, INTERPOLATION_AREA)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, float, c3, INTERPOLATION_AREA)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, float, c4, INTERPOLATION_AREA)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
// opencv
...
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c1, INTERPOLATION_LINEAR)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c3, INTERPOLATION_LINEAR)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c4, INTERPOLATION_LINEAR)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
// opencv
...
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c1, INTERPOLATION_NEAREST_POINT)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c3, INTERPOLATION_NEAREST_POINT)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c4, INTERPOLATION_NEAREST_POINT)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
...
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c1, INTERPOLATION_AREA)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c3, INTERPOLATION_AREA)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });
BENCHMARK_TEMPLATE(BM_Resize_tinycv_arm, uint8_t, c4, INTERPOLATION_AREA)->Args({ 320, 240, 640, 480 })->Args({ 640, 480, 320, 240 })->Args({ 1280, 720, 800, 600 })->Args({ 800, 600, 1280, 720 });

...
public:
    ...
    void BGR2I420apply(const BGR2I420Param &param)
    {
        ...
        tinycv::debug::randomFill<uint8_t>(src.get(), size.width * size.height * 3, 0, 255);
    ...
    void I4202BGRapply(const BGR2I420Param &param)
    {
        ...
        tinycv::debug::randomFill<T>(src.get(), size.width * size.height * 3 / 2, 0, 255);
    ...
    void BGRA2YV12apply(const BGR2I420Param &param)
    {
        ...
        tinycv::debug::randomFill<uint8_t>(src.get(), size.width * size.height * 4, 0, 255);

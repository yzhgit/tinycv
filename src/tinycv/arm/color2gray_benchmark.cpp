...
public:
    ...
    void BGR2GRAYapply()
    {
        tinycv::BGR2GRAY<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
    void GRAY2BGRapply()
    {
        tinycv::GRAY2BGR<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
    void BGRA2GRAYapply()
    {
        tinycv::BGRA2GRAY<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
    void GRAY2BGRAapply()
    {
        tinycv::GRAY2BGRA<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
};
} // namespace

...
public:
    ...
    void apply(const BGR2GRAYParam &param)
    {
        ...
        if (mode == 0) {
            ...
            tinycv::debug::randomFill<T>(src.get(), size.width * size.height * input_channels, 0, 255);
...
R(UT_GRAY2BGR_uint8_t_aarch64, uint8_t, c1, c3, 1, 1.01)
R(UT_BGRA2GRAY_float_aarch64, float, c4, c1, 2, 1e-4)
R(UT_BGRA2GRAY_uint8_t_aarch64, uint8_t, c4, c1, 2, 1.01)
R(UT_GRAY2BGRA_float_aarch64, float, c1, c4, 3, 1e-4)
R(UT_GRAY2BGRA_uint8_t_aarch64, uint8_t, c1, c4, 3, 1.01)
R(UT_RGB2GRAY_float_aarch64, float, c3, c1, 4, 1e-4)
R(UT_RGB2GRAY_uint8_t_aarch64, uint8_t, c3, c1, 4, 1.01)
R(UT_GRAY2RGB_float_aarch64, float, c1, c3, 5, 1e-4)
R(UT_GRAY2RGB_uint8_t_aarch64, uint8_t, c1, c3, 5, 1.01)
R(UT_RGBA2GRAY_float_aarch64, float, c4, c1, 6, 1e-4)
R(UT_RGBA2GRAY_uint8_t_aarch64, uint8_t, c4, c1, 6, 1.01)
R(UT_GRAY2RGBA_float_aarch64, float, c1, c4, 7, 1e-4)
R(UT_GRAY2RGBA_uint8_t_aarch64, uint8_t, c1, c4, 7, 1.01)
